...
const About = () => {
  return (
    ...
    >
      <Box me='auto' mt={['3em', '3em', '5em']}>
        <Box w={['16em', '16em', '32em']} ms={'6em'}>
          <Heading
            ...
            color={'#D9D9D9'}
            fontWeight='620'
            fontSize={['1.8rem', null, '2.5rem', '3.5rem']}
          >
      ...
      <Box w='39em'>
        <Box
          ms={['14.5em', '14.5em', null]}
          mt={['-0.8em', '-0.8em', null]}
          boxSize={'fit-content'}
          zIndex={-2}
        >
          <Image
            h={['12.76em', '12.76em', '22em']}
            w={['12.76em', '12.76em', '22em']}
            mt='0'
            src={bits}
            mb='0'
          ></Image>
        ...
        <Box
          mt={['-7.3em', '-7.3em', '-7.3em']}
          ms={['14.8em', '14.8em', '1em']}
          zIndex={-1}
          boxSize={'fit-content'}
        >
          <Image
